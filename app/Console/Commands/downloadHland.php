...
class downloadHland extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:download-hland';
    ...
    {$albums = [];
            ...
            foreach ($albums as $title => $items) {
                foreach ($items as $blogId => $subTitle) {
